            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        return '<a class="me-2 btn btn-sm rounded-0 py-0 edit_data btn-primary" href="javascript:void(0)" data-id="' + (row.language_id) + '">Edit</a><a class="btn btn-sm rounded-0 py-0 delete_data btn-danger" href="javascript:void(0)" data-id="' + (row.language_id) + '">Delete</a>';
                    }
                }
