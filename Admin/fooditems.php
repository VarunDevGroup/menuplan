            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="row mb-2">
                    <div class="col-sm-10">
                      <h3 class="card-title">Food Section - Items</h3>
                    </div><!-- /.col -->
                    <div class="col-sm-2">
...
<!-- Main Footer -->
<input type="hidden" id="foodsectionid" value="<?php echo $_GET['foodsectionid']; ?>">

    
<!-- REQUIRED SCRIPTS -->
<?php include($_SERVER['DOCUMENT_ROOT'] . '\menuplan\common\requiredscripts.php'); ?>
<!-- REQUIRED SCRIPTS -->
<script src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/menuplan/appjs/fooditems.js"></script>
