    ...
    function load_data() {
        ...
        authorsTbl = $('#tblData').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'FoodSectionName'
                },
                {
                    data: 'ItemImage',
                    render: function(data, type, row, meta) {
                        
                        return "<img style='width: 100px; height: 100px;' src=..\\" +  (row.ItemImage) + "></img>";
                    }
                },
                {
                    data: 'AvgGramPerKal'
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        return '<a class="btn btn-primary btn-sm" href="fooditems.php?foodsectionid=' + (row.FoodSectionID) + '"><i class="fas fa-database"></i>Items</a>'

                      //  return '<a class="btn btn-warning btn-sm edit_data" href="javascript:void(0)" data-id="' + (row.FoodSectionID) + '"><i class="fas fa-edit"></i>Edit</a>';
                    }
                }
                ,
                {
                    ...
                    render: function(data, type, row, meta) {
                       ...
                       return '<a class="btn btn-danger btn-sm  delete_data btn-danger" href="javascript:void(0)" data-id="' + (row.FoodSectionID) + '"> <i class="fas fa-eraser"></i>Delete</a>';
                    }
                }
