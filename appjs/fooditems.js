...
$(function() {
    ...
    function load_data() {
        ...
        authorsTbl = $('#tblData').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: "../BFF/get_fooditems.php",
                method: 'POST',
                data: {
                    foodsectionid: $(':hidden#foodsectionid').val()
                },
            },
            columns: [{
                    data: 'FoodItemID'
              ...
              
                {
                    ...
                    render: function(data, type, row, meta) {
                        return '<a class="btn btn-warning btn-sm edit_data" href="javascript:void(0)" data-id="' + (row.FoodItemID) + '"><i class="fas fa-edit"></i>Edit</a>';
                    }
                }
                ,
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        return '<a class="btn btn-danger btn-sm  delete_data btn-danger" href="javascript:void(0)" data-id="' + (row.FoodItemID) + '"> <i class="fas fa-eraser"></i>Delete</a>';
                    }
                }
